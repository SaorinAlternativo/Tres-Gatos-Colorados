...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top"><img src="assets/img/navbar-pata.svg" alt="..." /></a>
        ...
        <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">¿Qué ofrecemos?</h3>
                </div>
                <div class="row text-center">
                    <div class="col-md-4">
                        ...
                        <p class="text-muted">Contamos con la facilidad de encargar libros y pre-Reservar nuevos lanzamientos.</p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
                        ...
                        <h4 class="my-3">Soporte para Escritores</h4>
                        <p class="text-muted">Puedes enviar tu Portfolio de escritor y escritos para enviarlos a revisión.</p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
                        ...
                        <h4 class="my-3">Seguridad de información</h4>
                        <p class="text-muted">Mantenemos tu información y creaciones protegidas.</p>
                    </div>
                </div>
            </div>
        </section>
